...
if [ -f "C:\Development_tools\Game_Development\UE_4.17\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "C:\Development_tools\Game_Development\UE_4.17\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
